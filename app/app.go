...
type App struct {
	*baseapp.BaseApp
	...
	VutestKeeper vutestmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.VutestKeeper = *vutestmodulekeeper.NewKeeper(
		appCodec,
		keys[vutestmoduletypes.StoreKey],
		keys[vutestmoduletypes.MemStoreKey],
		app.GetSubspace(vutestmoduletypes.ModuleName),
	)
	vutestModule := vutestmodule.NewAppModule(appCodec, app.VutestKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(vutestmoduletypes.ModuleName)
